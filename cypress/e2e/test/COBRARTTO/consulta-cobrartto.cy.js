describe('Consulta cobrar tratamientos',()=>{
    beforeEach(()=>{
        cy.fixture('datos_oficina.datos.json').as('datos_oficina')
    });

    it('Consultar cobrar tratamiento localizador',async ()=>{
        cy.get('@datos_oficina').then((users) => {
            ...
            cy.getInfo(localizador).then((response) => {
                ...
                /*Cedula*/
                cy.get('#ufld\\:CCEDASEGENC\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((cedula)=>{
                    if(cedula.text() == ''){
                ...
                /*Nombre Completo*/ 
                cy.get('#ufld\\:XNOMAPEENC\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((xnombre)=>{
                    if(xnombre.text() == ''){
                ...
                /*Tipo Paciente*/
                cy.get('#ufld\\:XTIPOASEG\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((tipoaseg)=>{
                    if(tipoaseg.text() == ''){
                ...
                cy.get('#ufld\\:XCIASEG\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((xciaseg)=>{
                    if(xciaseg.text() == ''){
                ...
                cy.get('#ufld\\:XCLIENTE\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((xcliente)=>{
                    if(xcliente.text() == ''){
                ...
                cy.get('#ufld\\:XPLAN\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((xplan)=>{
                    if(xplan.text() == ''){
                ...
                /*Tipo de Localizador*/
                cy.get('#ufld\\:XTLOCALIZA\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((tipoLocaliza)=>{
                ...
                cy.get('#ufld\\:XCEL\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((cel)=>{
                    if(cel.text() == ''){
                ...
                cy.get('#ufld\\:XTLF\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((tlf)=>{
                    if(tlf.text() == ''){
                ...
                cy.get('#ufld\\:XEMAIL\\.LOCALIZADOR\\.NOMODEL\\:COBRARTTO\\.1').then((email)=>{
                    if(email.text() == ''){
